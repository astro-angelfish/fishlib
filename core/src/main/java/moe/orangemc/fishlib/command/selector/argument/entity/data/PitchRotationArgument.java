...
public class PitchRotationArgument implements SelectorArgument<IntegerRangeArgumentType> {
	@Override
	...
	public boolean matchEntity(Selector selector, Entity entity, IntegerRangeArgumentType value, Boolean parallelResult) throws CommandSyntaxException {
		return value.matches((int) entity.getLocation().getPitch()) && (parallelResult == null || parallelResult);
	}
